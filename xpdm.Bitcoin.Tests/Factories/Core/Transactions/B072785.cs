...
{
    static class B072785
    {
        #region Coinbase

        public static TestTx Coinbase = new TestTx
        {
            ExpectedHash = Hash256.Parse("2d7f4d1c25893dcaf538fdd1f34104687211ca7d8a1ba43c16b618d5fbc620c3"),
        ...
        {
            ExpectedHash = Hash256.Parse("3407a84dce0fe04fdab91608d1974941af3683ea6e4d904a30469485c50d336a"),
            Transaction = new Transaction
                {
                    Version = 1,
                    LockTime = 0,
        ...
        {
            ExpectedHash = Hash256.Parse("5edf5acf8f517d965219a5495321e0bedd761daf45bcdc59a33b07b520968b8c"),
            Transaction = new Transaction
                {
                    Version = 1,
                    LockTime = 0,
        ...
        public static TestTx Tx3 = new TestTx
        {
            ExpectedHash = Hash256.Parse("65c35615b476c86f28a4d3a8985ea161cc2e35e6574eacbd68942782ce29804c"),
            Transaction = new Transaction
                {
                    Version = 1,
                    LockTime = 0,
        ...
        public static TestTx Tx4 = new TestTx
        {
            ExpectedHash = Hash256.Parse("89aa32f6e1b047e740401ce4fd43a865631de5a959fde7451936c28c52249b56"),
            Transaction = new Transaction
                {
                    Version = 1,
                    LockTime = 0,
        ...
        public static TestTx Tx5 = new TestTx
        {
            ExpectedHash = Hash256.Parse("e3e69c802b7e36d220151e4ccdeace1d58ca2af97c5fd970314bbecd9767a514"),
            Transaction = new Transaction
                {
                    Version = 1,
                    LockTime = 0,
        ...
        static B072785()
        {
            ...
            Tx3.Transaction.Freeze();
            Tx4.Transaction.Freeze();
            Tx5.Transaction.Freeze();
        }
    }
}
