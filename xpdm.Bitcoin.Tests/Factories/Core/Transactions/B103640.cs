...
{
    static class B103640
    {
        #region Coinbase

        public static TestTx Coinbase = new TestTx
        {
            ExpectedHash = Hash256.Parse("cdd3cf10fe83c28d1ac80714a48440e47f1c6b6950fec54f6b8ea04241004cb5"),
        ...
        {
            ExpectedHash = Hash256.Parse("945691940e0ccd9f526ee1edd57a77ce170804915749702f5564c49b1f70f330"),
            Transaction = new Transaction
                {
                    Version = 1,
                    LockTime = 0,
        ...
        public static readonly byte[] Tx1_Out0_MinimalForSignatureVerificationSource = new byte[] {
