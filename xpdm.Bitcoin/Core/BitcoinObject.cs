...
namespace xpdm.Bitcoin.Core
{
    ...
    public abstract class BitcoinObject
    {
        ...
        protected BitcoinObject(Stream stream)
        {
        ...
        protected BitcoinObject(byte[] buffer, int offset)
        {
        ...
        protected static T[] ReadVarArray<T>(Stream stream) where T : BitcoinObject, new()
        {
            Contract.Requires<ArgumentNullException>(stream != null, "stream");
